...
package com.cloudminds.crss.codegen.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import com.cloudminds.crss.codegen.entity.ColumnEntity;
import com.cloudminds.crss.codegen.entity.GenConfig;
import com.cloudminds.crss.codegen.entity.TableEntity;
import com.cloudminds.crss.common.core.constant.CommonConstants;
import com.cloudminds.crss.common.core.exception.CheckedException;
import java.io.File;
    ...
    private String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains(MAPPER_XML_VM)) {
            return CommonConstants.BACK_END_PROJECT + File.separator + "src" + File.separator + "main" + File.separator
                    + "resources" + File.separator + "dao" + File.separator + className + "Mapper.xml";
        }
        ...
        if (template.contains(CRUD_JS_VM)) {
            return CommonConstants.FRONT_END_PROJECT + File.separator + "src" + File.separator + "const"
                    + File.separator + "crud" + File.separator + moduleName + File.separator + className.toLowerCase()
                    + ".js";
        }
