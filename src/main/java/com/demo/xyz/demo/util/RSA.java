...
public class RSA {
	 ...
	 * @return 布尔值
	 */
	public static boolean verify(String content, String sign, String publicKey, String signAlgorithms,
	 ...
	 * @return 布尔值
	 */
	public static boolean verify(String content, String sign, PublicKey publicKey, String signAlgorithms,
			String characterEncoding) {
		try {
			java.security.Signature signature = java.security.Signature.getInstance(signAlgorithms);
	...
	public static String decrypt(String content, String privateKey, String characterEncoding)
		...
		try (InputStream ins = new ByteArrayInputStream(Base64.decode(content));
	 ...
	 * @return 公钥
	 */
	public static PublicKey getPublicKey(String key, String signAlgorithms)
			throws GeneralSecurityException, IOException {
	...
	public static byte[] encrypt(byte[] plainBytes, PublicKey publicKey, int keyLength, int reserveSize,
			String cipherAlgorithm) throws IOException, GeneralSecurityException {
	...
	public static String encrypt(String content, String publicKey, String cipherAlgorithm, String characterEncoding)
			throws IOException, GeneralSecurityException {
		return Base64.encode(RSA.encrypt(content.getBytes(characterEncoding), RSA.getPublicKey(publicKey), 1024, 11,
				cipherAlgorithm));
	}
